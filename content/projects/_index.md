...
- **golident** - generate dazzling identicons with Conway's Game of Life
  - [github](https://github.com/patrickarmengol/golident)
  - using numpy for gol simulation
  - matplotlib for visualization and applying colorscheme
